...
function scene:create(event)
    ...
    local fundo = display.newImage(sceneGroup, "imagens/ContraCapa/Contracapa.png")
    fundo.x = display.contentCenterX
    fundo.y = display.contentCenterY

   
    local botaoproximo = display.newImage(sceneGroup, "imagens/Gerais/Início.png")
    botaoproximo.x = 650
    botaoproximo.y = 900
    ...
    function botaoanterior:tap(event)
        composer.gotoScene("Referencia", { effect = "fromLeft", time = 1000 })
    end
