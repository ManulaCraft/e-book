...
function scene:create(event)
    ...
    local fundo = display.newImage(sceneGroup, "imagens/referencia/Referências.png")
    ...
    local somInicio = audio.loadSound("Audios/Referências.mp3")
    local canalSom = 1 
    ...
    function botaoanterior:tap(event)
        composer.gotoScene("Pag6", { effect = "fromLeft", time = 1000 })
    end
